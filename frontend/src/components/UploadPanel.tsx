...
export default function UploadPanel({ onLoad }: Props) {
  ...
  return (
    <div className="flex items-center gap-2">
      <label className="flex cursor-pointer items-center gap-1 rounded-md border border-slate-200 bg-white px-2.5 py-1 text-xs font-medium text-slate-600 shadow-xs hover:bg-slate-50 transition-colors">
        📷 图片
        <input
          ref={imageRef}
          type="file"
